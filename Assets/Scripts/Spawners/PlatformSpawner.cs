...
public class PlatformSpawner : TimedSpawner
{
    protected int nextindex;
    public float addedXOffset = 10f;
    ...
    protected override void Spawn()
    {
        ...
        nextGameObject.transform.position = this.transform.position + DetermineNextPosition() + new Vector3(5f, 0f, 0f);
